...
resource aksAzureMonitor 'Microsoft.OperationalInsights/workspaces@2022-10-01' = {
...
resource aks 'Microsoft.ContainerService/managedClusters@2023-08-01' = {
  ...
  properties: {
    ...
    networkProfile: {
      ...
      serviceCidr: aksSettings.serviceCidr
      dnsServiceIP: aksSettings.dnsServiceIP
...
resource aks 'Microsoft.ContainerService/managedClusters@2023-08-01' = {
  ...
  properties: {
    ...
    networkProfile: {
      ...
      serviceCidr: aksSettings.serviceCidr
      dnsServiceIP: aksSettings.dnsServiceIP
      dockerBridgeCidr: aksSettings.dockerBridgeCidr
      outboundType: aksSettings.outboundType
      loadBalancerSku: aksSettings.loadBalancerSku
    }
